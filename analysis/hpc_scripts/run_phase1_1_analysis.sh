#!/bin/bash
#BSUB -J phase1_1_analysis
#BSUB -o /work3/s233249/ImgiNav/ImgiNav/analysis/hpc_scripts/logs/phase1_1_analysis.%J.out
#BSUB -e /work3/s233249/ImgiNav/ImgiNav/analysis/hpc_scripts/logs/phase1_1_analysis.%J.err
#BSUB -n 4
...
PYTHON_SCRIPT="${BASE_DIR}/analysis/phase1_1_analysis.py"
...
# =============================================================================
echo "=========================================="
echo "Phase 1.1: Latent Channel Sweep Analysis"
echo "=========================================="
...
if [ ! -d "${PHASE_DIR}" ]; then
  ...
  echo "Please ensure Phase 1.1 experiments have completed." >&2
  exit 1
fi
