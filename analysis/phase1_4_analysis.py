#!/usr/bin/env python3
"""
Analysis script for Phase 1.4: Loss Tuning
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Analyze Phase 1.4 experiments")
    parser.add_argument(
        "--phase-dir",
        type=str,
        default="outputs/phase1_4_loss_tuning",
    ...
    print("=" * 80)
    print("Phase 1.4: Loss Tuning Analysis")
    print("=" * 80)
