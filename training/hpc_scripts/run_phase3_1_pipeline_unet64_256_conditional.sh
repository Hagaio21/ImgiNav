#!/bin/bash
#BSUB -J phase3_1_pipeline_unet64_256_conditional
#BSUB -o /work3/s233249/ImgiNav/ImgiNav/training/hpc_scripts/logs/phase3_1_pipeline_unet64_256_conditional.%J.out
#BSUB -e /work3/s233249/ImgiNav/ImgiNav/training/hpc_scripts/logs/phase3_1_pipeline_unet64_256_conditional.%J.err
#BSUB -n 8
...
DIFFUSION_CONFIG="${BASE_DIR}/experiments/diffusion/phase3/phase3_1_diffusion_64x64_bottleneck_attn_unet64_256_conditional.yaml"
...
# =============================================================================
echo "=========================================="
echo "Phase 3.1: Fine-tuning Pipeline (UNet64, 256×256, Conditional)"
