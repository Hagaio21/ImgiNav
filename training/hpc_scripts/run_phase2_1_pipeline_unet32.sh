#!/bin/bash
#BSUB -J phase2_1_pipeline_unet32
#BSUB -o /work3/s233249/ImgiNav/ImgiNav/training/hpc_scripts/logs/phase2_1_pipeline_unet32.%J.out
#BSUB -e /work3/s233249/ImgiNav/ImgiNav/training/hpc_scripts/logs/phase2_1_pipeline_unet32.%J.err
#BSUB -n 8
...
DIFFUSION_CONFIG="${BASE_DIR}/experiments/diffusion/phase2/phase2_1_diffusion_64x64_bottleneck_attn_unet32.yaml"
...
# =============================================================================
echo "=========================================="
echo "Phase 2.1: Training Pipeline (UNet32)"
...
echo "  3. Train diffusion model (UNet32, base_channels=32)"
echo "=========================================="
