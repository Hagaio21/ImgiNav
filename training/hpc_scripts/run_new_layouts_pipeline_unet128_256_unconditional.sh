#!/bin/bash
#BSUB -J new_layouts_pipeline_unet128_256_unconditional
#BSUB -o /work3/s233249/ImgiNav/ImgiNav/training/hpc_scripts/logs/new_layouts_pipeline_unet128_256_unconditional.%J.out
#BSUB -e /work3/s233249/ImgiNav/ImgiNav/training/hpc_scripts/logs/new_layouts_pipeline_unet128_256_unconditional.%J.err
#BSUB -n 8
...
DIFFUSION_CONFIG="${BASE_DIR}/experiments/diffusion/new_layouts/new_layouts_diffusion_64x64_bottleneck_attn_unet128_256_unconditional.yaml"
...
# =============================================================================
echo "=========================================="
echo "New Layouts: Training Pipeline (UNet128, 256×256, Unconditional)"
