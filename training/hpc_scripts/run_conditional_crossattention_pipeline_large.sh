#!/bin/bash
#BSUB -J conditional_crossattention_pipeline_large
#BSUB -o /work3/s233249/ImgiNav/ImgiNav/training/hpc_scripts/logs/conditional_crossattention_pipeline_large.%J.out
#BSUB -e /work3/s233249/ImgiNav/ImgiNav/training/hpc_scripts/logs/conditional_crossattention_pipeline_large.%J.err
#BSUB -n 8
#BSUB -R "rusage[mem=24000]"  # Increased memory for larger model
#BSUB -gpu "num=1"
#BSUB -W 24:00
#BSUB -q gpuv100
...
# =============================================================================
echo "=========================================="
echo "Conditional Cross-Attention Diffusion Pipeline (LARGE MODEL)"
...
echo "  5. Train conditional cross-attention diffusion model (LARGE)"
echo "     - base_channels: 96 (vs 48 in small model)"
echo "     - depth: 4 (vs 3 in small model)"
echo "     - attention_heads: 8 (vs 4 in small model)"
echo "     - batch_size: 16 (vs 32 in small model)"
echo "=========================================="
...
if [ $EXIT_CODE -eq 0 ]; then
  ...
  echo "Model: LARGE (96 base_channels, depth 4, 8 attention heads)"
  echo "End: $(date)"
  echo "=========================================="
else
  echo ""
