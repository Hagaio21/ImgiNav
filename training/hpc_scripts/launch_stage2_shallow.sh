#!/bin/bash
# Launch Stage 2 fine-tuning experiments for shallower models (depth 3-4)
# These experiments fine-tune Stage 1 checkpoints with semantic losses
# Focus: UNet32_d3, UNet64_d4, UNet128_d4 (avoiding depth 5 variants)
...
echo "Focus: Shallower models (depth 3-4) with semantic losses"
echo "=========================================="
echo ""
...
# Stage 2: UNet32 depth 3 (shallowest)
...
# Stage 2: UNet128 depth 4
echo "  - stage2_unet128_d4 (base_channels 128, depth 4, 2 resblocks)"
bsub < "${SCRIPT_DIR}/run_stage2_unet128_d4.sh"
sleep 2

echo ""
echo "=========================================="
echo "All Stage 2 shallow experiments submitted!"
echo "=========================================="
echo ""
...
echo "  Stage 2 Fine-tuning (3 shallow experiments):"
echo "    - stage2_unet32_d3 (base_channels 32, depth 3, 2 resblocks)"
...
echo ""
echo "Skipped deeper variants:"
echo "  - stage2_unet64_d5 (depth 5)"
