#!/bin/bash
# Launch script for New Layouts pipelines
# This script submits all new_layouts pipeline jobs to the HPC cluster
#
...
# =============================================================================
PIPELINE_SCRIPTS=(
    "run_new_layouts_pipeline_unet48_256_unconditional.sh"
    "run_new_layouts_pipeline_unet64_256_unconditional.sh"
    "run_new_layouts_pipeline_unet128_256_unconditional.sh"
)
...
# =============================================================================
echo "=============================================================================="
echo "Launching New Layouts Pipeline Jobs (256x256 input, Unconditional)"
echo "=============================================================================="
echo ""
