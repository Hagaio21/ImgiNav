#!/bin/bash
#BSUB -J preembed_latents_phase1_6
#BSUB -o /work3/s233249/ImgiNav/ImgiNav/training/hpc_scripts/logs/preembed_latents_phase1_6.%J.out
#BSUB -e /work3/s233249/ImgiNav/ImgiNav/training/hpc_scripts/logs/preembed_latents_phase1_6.%J.err
#BSUB -n 8
...
# Autoencoder config and checkpoint (Phase 1.6 - Normalized)
AUTOENCODER_CONFIG="${BASE_DIR}/experiments/autoencoders/phase1/phase1_6_AE_normalized.yaml"
...
if [ ! -f "${AUTOENCODER_CHECKPOINT}" ]; then
  ...
  AUTOENCODER_CHECKPOINT="/work3/s233249/ImgiNav/experiments/phase1/phase1_6_AE_normalized/phase1_6_AE_normalized_checkpoint_latest.pt"
  if [ ! -f "${AUTOENCODER_CHECKPOINT}" ]; then
    echo "ERROR: Autoencoder checkpoint not found at best or latest path" >&2
    echo "  Expected: /work3/s233249/ImgiNav/experiments/phase1/phase1_6_AE_normalized/phase1_6_AE_normalized_checkpoint_best.pt" >&2
    echo "  Or: /work3/s233249/ImgiNav/experiments/phase1/phase1_6_AE_normalized/phase1_6_AE_normalized_checkpoint_latest.pt" >&2
    exit 1
  fi
fi
...
# =============================================================================
echo "=========================================="
echo "Pre-embedding Layout Dataset (Phase 1.6 - Normalized)"
...
if [ $EXIT_CODE -eq 0 ]; then
  ...
  echo "=========================================="
  echo ""
  echo "Next step: Run diffusion experiments with Phase 1.6 normalized autoencoder"
