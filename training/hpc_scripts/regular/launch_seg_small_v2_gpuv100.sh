#!/bin/bash
# Launch script for Seg Small Diffusion experiments (v2 structure) - gpuv100 queue
# Submits all 9 small seg experiments:
# - rooms: both, graph, povs (3)
# - scenes: both, graph, povs (3)
# - both: both, graph, povs (3)
...
# All seg small experiments
CONFIGS=(
    "experiments/diffusion/v2/seg/rooms/both/small_down_bottleneck.yaml"
...
echo "=============================================================================="
echo "Launching Seg Small Diffusion Training (v2 structure) - gpuv100 queue"
echo "=============================================================================="
