#!/bin/bash
# Launch script for 9 Seg Diffusion v2 Wide/Shallow experiments
# Queue distribution:
...
echo "=============================================================================="
echo "Launching 9 Seg Diffusion v2 Wide/Shallow Experiments"
echo "=============================================================================="
echo ""
...
GPUL40S_CONFIGS=(
    "experiments/diffusion/v2/seg/rooms_povs_large_wide_shallow_v2.yaml"
    "experiments/diffusion/v2/seg/rooms_graphs_large_wide_shallow_v2.yaml"
)
...
GPUV100_CONFIGS=(
    "experiments/diffusion/v2/seg/rooms_both_small_wide_shallow_v2.yaml"
    "experiments/diffusion/v2/seg/rooms_graphs_small_wide_shallow_v2.yaml"
    "experiments/diffusion/v2/seg/rooms_povs_small_wide_shallow_v2.yaml"
    "experiments/diffusion/v2/seg/rooms_povs_medium_wide_shallow_v2.yaml"
    "experiments/diffusion/v2/seg/rooms_graphs_medium_wide_shallow_v2.yaml"
)
