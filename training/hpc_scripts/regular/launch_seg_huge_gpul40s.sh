#!/bin/bash
# Launch script for Seg Huge Diffusion experiments
# Submits: rooms/povs/huge_down_bottleneck.yaml and scenes/graph/huge_down_bottleneck.yaml
# Uses gpul40s queue with 48 hours runtime
...
# Seg huge experiments
CONFIGS=(
    "experiments/diffusion/v2/seg/rooms/povs/huge_down_bottleneck.yaml"
    "experiments/diffusion/v2/seg/scenes/graph/huge_down_bottleneck.yaml"
)

echo "=============================================================================="
echo "Launching Seg Huge Diffusion Training"
echo "=============================================================================="
echo "Submitting ${#CONFIGS[@]} job(s) to gpul40s queue (48 hours)..."
echo ""
