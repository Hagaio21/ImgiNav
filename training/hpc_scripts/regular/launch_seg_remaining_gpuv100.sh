#!/bin/bash
# Launch script for remaining Seg Diffusion experiments - gpuv100 queue
# Submits 4 experiments that haven't been done yet:
# - rooms/graph/small_down_bottleneck.yaml
# - rooms/povs/small_down_bottleneck.yaml
# - rooms/graph/medium_down_bottleneck.yaml
# - rooms/povs/medium_down_bottleneck.yaml
# (Already done: rooms/both/small, rooms/both/medium with seed 9999)
...
# Remaining seg experiments (4 total)
CONFIGS=(
    "experiments/diffusion/v2/seg/rooms/graph/small_down_bottleneck.yaml"
    "experiments/diffusion/v2/seg/rooms/povs/small_down_bottleneck.yaml"
    "experiments/diffusion/v2/seg/rooms/graph/medium_down_bottleneck.yaml"
    "experiments/diffusion/v2/seg/rooms/povs/medium_down_bottleneck.yaml"
)

echo "=============================================================================="
echo "Launching Remaining Seg Diffusion Training (gpuv100 queue)"
echo "=============================================================================="
