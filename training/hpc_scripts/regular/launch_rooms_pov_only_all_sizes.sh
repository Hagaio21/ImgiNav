#!/bin/bash
# Launch script for rooms-only experiments with POV conditioning only (no text/graph)
...
CONFIGS=(
    "experiments/diffusion/clip/regular_rooms/small_down_bottleneck_pov_only.yaml"
    "experiments/diffusion/clip/regular_rooms/medium_down_bottleneck_pov_only.yaml"
    "experiments/diffusion/clip/regular_rooms/large_down_bottleneck_pov_only.yaml"
)

echo "=============================================================================="
echo "Launching Rooms-Only Experiments (POV Only, Down+Bottleneck Attention)"
echo "=============================================================================="
