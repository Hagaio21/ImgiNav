#!/bin/bash
# Launch script for Seg Large Diffusion experiment - POV only (rooms)
# Submits: rooms/povs/large_down_bottleneck.yaml
# Uses gpul40s queue
...
# Seg large rooms POV only experiment
CONFIGS=(
    "experiments/diffusion/v2/seg/rooms/povs/large_down_bottleneck.yaml"
)

echo "=============================================================================="
echo "Launching Seg Large Diffusion Training - POV Only (Rooms)"
echo "=============================================================================="
