#!/bin/bash
# Launch script for Seg Both (rooms+scenes) Diffusion experiments - gpua100 queue
# Submits 6 both experiments:
# - both/both/small_down_bottleneck.yaml
# - both/graph/small_down_bottleneck.yaml
# - both/povs/small_down_bottleneck.yaml
# - both/both/medium_down_bottleneck.yaml
# - both/graph/medium_down_bottleneck.yaml
# - both/povs/medium_down_bottleneck.yaml
...
# Seg both experiments (6 total)
CONFIGS=(
    # Small (3)
    "experiments/diffusion/v2/seg/both/both/small_down_bottleneck.yaml"
    "experiments/diffusion/v2/seg/both/graph/small_down_bottleneck.yaml"
    "experiments/diffusion/v2/seg/both/povs/small_down_bottleneck.yaml"
    # Medium (3)
    "experiments/diffusion/v2/seg/both/both/medium_down_bottleneck.yaml"
    "experiments/diffusion/v2/seg/both/graph/medium_down_bottleneck.yaml"
    "experiments/diffusion/v2/seg/both/povs/medium_down_bottleneck.yaml"
)

echo "=============================================================================="
echo "Launching Seg Both (rooms+scenes) Diffusion Training (gpua100 queue)"
echo "=============================================================================="
