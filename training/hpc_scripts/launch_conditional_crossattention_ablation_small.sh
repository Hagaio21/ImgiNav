#!/bin/bash
# Launch script for Conditional Cross-Attention Diffusion Ablation Experiments (SMALL MODELS)
# This script submits all small model ablation experiment jobs to the HPC cluster
#
...
#
# Small models: 48 base_channels, depth 3, 2 attention heads
...
# =============================================================================
echo "=============================================================================="
echo "Launching Conditional Cross-Attention Diffusion Ablation Experiments (SMALL)"
echo "=============================================================================="
echo ""
...
echo ""
echo "Total experiments: ${#SMALL_EXPERIMENTS[@]}"
echo "=============================================================================="
echo ""

# Prompt for confirmation
read -p "Submit all small model ablation experiments? (y/N): " -n 1 -r
echo
if [[ ! $REPLY =~ ^[Yy]$ ]]; then
    echo "Aborted."
    exit 0
