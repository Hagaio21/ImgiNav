#!/bin/bash
#BSUB -J autoencoder_exps_l40s[1-2]
#BSUB -o /work3/s233249/ImgiNav/ImgiNav/training/hpc_scripts/logs/autoencoder_exps_l40s.%J.%I.out
#BSUB -e /work3/s233249/ImgiNav/ImgiNav/training/hpc_scripts/logs/autoencoder_exps_l40s.%J.%I.err
#BSUB -n 8
