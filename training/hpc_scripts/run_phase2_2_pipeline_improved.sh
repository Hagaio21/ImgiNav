#!/bin/bash
#BSUB -J phase2_2_pipeline_improved
#BSUB -o /work3/s233249/ImgiNav/ImgiNav/training/hpc_scripts/logs/phase2_2_pipeline_improved.%J.out
#BSUB -e /work3/s233249/ImgiNav/ImgiNav/training/hpc_scripts/logs/phase2_2_pipeline_improved.%J.err
#BSUB -n 8
#BSUB -R "rusage[mem=16000]"  # 64x64x4 latents are much smaller than 512x512 images
#BSUB -gpu "num=1"
#BSUB -W 48:00  # Extended wall time for embedding + diffusion training
#BSUB -q gpul40s
...
# =============================================================================
echo "=========================================="
echo "Phase 2.2: Improved Diffusion Pipeline"
echo "Autoencoder + Embedding + Diffusion Training"
echo "=========================================="
