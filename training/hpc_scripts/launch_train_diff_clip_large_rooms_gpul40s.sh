#!/bin/bash
# Launch script for Large Rooms CLIP Diffusion models on gpul40s queue
...
CONFIGS=(
    ...
    # "experiments/diffusion/clip/regular_rooms/large_all.yaml"
    # "experiments/diffusion/clip/regular_rooms/large_down.yaml"
    # "experiments/diffusion/clip/regular_rooms/large_up.yaml"
)
...
echo "=============================================================================="
echo "Launching Large Rooms CLIP Diffusion Training (gpul40s queue)"
echo "=============================================================================="
