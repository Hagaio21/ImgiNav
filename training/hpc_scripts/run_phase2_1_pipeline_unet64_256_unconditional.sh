#!/bin/bash
#BSUB -J phase2_1_pipeline_unet64_256_unconditional
#BSUB -o /work3/s233249/ImgiNav/ImgiNav/training/hpc_scripts/logs/phase2_1_pipeline_unet64_256_unconditional.%J.out
#BSUB -e /work3/s233249/ImgiNav/ImgiNav/training/hpc_scripts/logs/phase2_1_pipeline_unet64_256_unconditional.%J.err
#BSUB -n 8
...
DIFFUSION_CONFIG="${BASE_DIR}/experiments/diffusion/phase2/phase2_1_diffusion_64x64_bottleneck_attn_unet64_256_unconditional.yaml"
...
# =============================================================================
echo "=========================================="
echo "Phase 2.1: Training Pipeline (UNet64, 256×256, Unconditional)"
