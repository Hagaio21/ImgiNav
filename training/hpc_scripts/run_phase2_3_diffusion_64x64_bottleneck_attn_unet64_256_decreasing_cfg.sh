#!/bin/bash
#BSUB -J phase2_3_diffusion_decreasing_cfg
#BSUB -o /work3/s233249/ImgiNav/ImgiNav/training/hpc_scripts/logs/phase2_3_diffusion_decreasing_cfg.%J.out
#BSUB -e /work3/s233249/ImgiNav/ImgiNav/training/hpc_scripts/logs/phase2_3_diffusion_decreasing_cfg.%J.err
#BSUB -n 8
