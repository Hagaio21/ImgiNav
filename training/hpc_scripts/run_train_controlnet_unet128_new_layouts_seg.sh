#!/bin/bash
#BSUB -J train_controlnet_unet128_seg
#BSUB -o /work3/s233249/ImgiNav/ImgiNav/training/hpc_scripts/logs/train_controlnet_unet128_seg.%J.out
#BSUB -e /work3/s233249/ImgiNav/ImgiNav/training/hpc_scripts/logs/train_controlnet_unet128_seg.%J.err
#BSUB -n 8
...
CONFIG_PATH="${PROJECT_ROOT}/ImgiNav/experiments/controlnet/new_layouts/controlnet_unet128_d4_new_layouts_seg.yaml"
...
# ----------------------------------------------------------------------
echo "=============================================================="
echo " ControlNet Training Pipeline (UNet128, SEG)"
echo "=============================================================="
