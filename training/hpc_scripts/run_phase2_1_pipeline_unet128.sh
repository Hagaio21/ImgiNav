#!/bin/bash
#BSUB -J phase2_1_pipeline_unet128
#BSUB -o /work3/s233249/ImgiNav/ImgiNav/training/hpc_scripts/logs/phase2_1_pipeline_unet128.%J.out
#BSUB -e /work3/s233249/ImgiNav/ImgiNav/training/hpc_scripts/logs/phase2_1_pipeline_unet128.%J.err
#BSUB -n 8
...
DIFFUSION_CONFIG="${BASE_DIR}/experiments/diffusion/phase2/phase2_1_diffusion_64x64_bottleneck_attn_unet128.yaml"
...
# =============================================================================
echo "=========================================="
echo "Phase 2.1: Training Pipeline (UNet128)"
...
echo "  3. Train diffusion model (UNet128, base_channels=128)"
echo "=========================================="
