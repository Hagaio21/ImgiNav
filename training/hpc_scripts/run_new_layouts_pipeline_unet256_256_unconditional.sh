#!/bin/bash
#BSUB -J new_layouts_pipeline_unet256_256_unconditional
#BSUB -o /work3/s233249/ImgiNav/ImgiNav/training/hpc_scripts/logs/new_layouts_pipeline_unet256_256_unconditional.%J.out
#BSUB -e /work3/s233249/ImgiNav/ImgiNav/training/hpc_scripts/logs/new_layouts_pipeline_unet256_256_unconditional.%J.err
#BSUB -n 8
...
DIFFUSION_CONFIG="${BASE_DIR}/experiments/diffusion/new_layouts/new_layouts_diffusion_64x64_bottleneck_attn_unet256_256_unconditional.yaml"
...
# =============================================================================
echo "=========================================="
echo "New Layouts: Training Pipeline (UNet256, Unconditional)"
...
echo "  3. Train diffusion model (UNet256, base_channels=256, depth=4) UNCONDITIONAL (cfg_dropout_rate=1.0)"
