#!/bin/bash
# Launch script for Medium Rooms CLIP Diffusion models on gpul40s queue
# Submits: medium_bottleneck (only variant available for rooms)
...
echo "=============================================================================="
echo "Launching Medium Rooms CLIP Diffusion Training (gpul40s queue)"
echo "=============================================================================="
