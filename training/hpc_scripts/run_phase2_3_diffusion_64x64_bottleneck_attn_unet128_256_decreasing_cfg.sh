#!/bin/bash
#BSUB -J phase2_3_diffusion_decreasing_cfg_unet128
#BSUB -o /work3/s233249/ImgiNav/ImgiNav/training/hpc_scripts/logs/phase2_3_diffusion_decreasing_cfg_unet128.%J.out
#BSUB -e /work3/s233249/ImgiNav/ImgiNav/training/hpc_scripts/logs/phase2_3_diffusion_decreasing_cfg_unet128.%J.err
#BSUB -n 8
...
DIFFUSION_CONFIG="${BASE_DIR}/experiments/diffusion/phase2/phase2_3_diffusion_64x64_bottleneck_attn_unet128_256_decreasing_cfg.yaml"
...
echo "  - UNet128 architecture (base_channels=128)"
echo ""
...
EMBEDDING_MANIFEST="/work3/s233249/ImgiNav/experiments/new_layouts/new_layouts_diffusion_64x64_bottleneck_attn_unet128_256_unconditional/embeddings/manifest_with_latents.csv"
