#!/bin/bash
#BSUB -J new_layouts_pipeline_unet64_256_attn_all_unconditional
#BSUB -o /work3/s233249/ImgiNav/ImgiNav/training/hpc_scripts/logs/new_layouts_pipeline_unet64_256_attn_all_unconditional.%J.out
#BSUB -e /work3/s233249/ImgiNav/ImgiNav/training/hpc_scripts/logs/new_layouts_pipeline_unet64_256_attn_all_unconditional.%J.err
#BSUB -n 8
#BSUB -R "rusage[mem=16000]"
#BSUB -gpu "num=1"
#BSUB -W 48:00  # Extended wall time for attention at all layers (500 epochs)
#BSUB -q gpul40s
...
DIFFUSION_CONFIG="${BASE_DIR}/experiments/diffusion/new_layouts/new_layouts_diffusion_64x64_bottleneck_attn_unet64_256_attn_all_unconditional.yaml"
...
# =============================================================================
echo "=========================================="
echo "New Layouts: Training Pipeline (UNet64_attn_all, Unconditional)"
...
echo "  3. Train diffusion model (UNet64_attn_all, base_channels=64, depth=4, attention at all layers) UNCONDITIONAL (cfg_dropout_rate=1.0)"
