#!/bin/bash
#BSUB -J phase2_2_diffusion_improved
#BSUB -o /work3/s233249/ImgiNav/ImgiNav/training/hpc_scripts/logs/phase2_2_diffusion_improved.%J.out
#BSUB -e /work3/s233249/ImgiNav/ImgiNav/training/hpc_scripts/logs/phase2_2_diffusion_improved.%J.err
#BSUB -n 8
...
DIFFUSION_CONFIG="${BASE_DIR}/experiments/diffusion/phase2/phase2_2_diffusion_improved.yaml"
...
# =============================================================================
echo "=========================================="
echo "Phase 2.2: Improved Diffusion Training"
echo "=========================================="
...
echo "  - EMA (Exponential Moving Average) for UNet"
echo "  - SNRWeightedNoiseLoss (instead of MSELoss)"
echo "  - Increased UNet capacity (base_channels=96)"
echo "  - CosineScheduler (instead of LinearScheduler)"
echo "  - More attention layers (downs, bottleneck, ups)"
echo "  - CosineAnnealingLR learning rate scheduler"
echo ""
echo "Training Details:"
echo "  - Uses same VAE from phase2_1_VAE_64x64_structural_256"
echo "  - 500 epochs"
echo "  - Batch size: 128"
echo "  - 1000 noise steps with CosineScheduler"
echo "=========================================="
...
EMBEDDING_MANIFEST="/work3/s233249/ImgiNav/experiments/phase2/phase2_2_diffusion_improved/embeddings/manifest_with_latents.csv"
