#!/bin/bash
#BSUB -J phase2_1_pipeline_unet64
#BSUB -o /work3/s233249/ImgiNav/ImgiNav/training/hpc_scripts/logs/phase2_1_pipeline_unet64.%J.out
#BSUB -e /work3/s233249/ImgiNav/ImgiNav/training/hpc_scripts/logs/phase2_1_pipeline_unet64.%J.err
#BSUB -n 8
...
DIFFUSION_CONFIG="${BASE_DIR}/experiments/diffusion/phase2/phase2_1_diffusion_64x64_bottleneck_attn_unet64.yaml"
...
# =============================================================================
echo "=========================================="
echo "Phase 2.1: Training Pipeline (UNet64)"
...
echo "  3. Train diffusion model (UNet64, base_channels=64)"
echo "=========================================="
