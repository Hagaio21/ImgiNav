#!/bin/bash
#BSUB -J phase3_1_pipeline_unet128_256_conditional
#BSUB -o /work3/s233249/ImgiNav/ImgiNav/training/hpc_scripts/logs/phase3_1_pipeline_unet128_256_conditional.%J.out
#BSUB -e /work3/s233249/ImgiNav/ImgiNav/training/hpc_scripts/logs/phase3_1_pipeline_unet128_256_conditional.%J.err
#BSUB -n 8
#BSUB -R "rusage[mem=16000]"  # Reduced from 32GB - 64x64x4 latents are much smaller than 512x512 images
#BSUB -gpu "num=1"
#BSUB -W 48:00  # Extended wall time for larger model fine-tuning
#BSUB -q gpul40s
...
DIFFUSION_CONFIG="${BASE_DIR}/experiments/diffusion/phase3/phase3_1_diffusion_64x64_bottleneck_attn_unet128_256_conditional.yaml"
...
# =============================================================================
echo "=========================================="
echo "Phase 3.1: Fine-tuning Pipeline (UNet128, 256×256, Conditional)"
