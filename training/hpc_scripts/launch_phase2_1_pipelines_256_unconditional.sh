#!/bin/bash
# Launch script for Phase 2.1 pipelines with 256x256 input - Unconditional versions
# This script submits all unconditional pipeline jobs to the HPC cluster
#
# Unconditional models use cfg_dropout_rate=1.0 (100% dropout = always unconditional training)
...
PIPELINE_SCRIPTS=(
    ...
    "run_phase2_1_pipeline_unet64_256_unconditional.sh"
    "run_phase2_1_pipeline_unet128_256_unconditional.sh"
)
...
# =============================================================================
echo "=============================================================================="
echo "Launching Phase 2.1 Pipeline Jobs (256x256 input, Unconditional)"
echo "=============================================================================="
echo ""
...
echo "  - UNet48_256: base_channels=48, batch_size=128, unconditional"
echo "  - UNet64_256: base_channels=64, batch_size=96, unconditional"
echo "  - UNet128_256: base_channels=128, batch_size=64, unconditional"
echo ""
