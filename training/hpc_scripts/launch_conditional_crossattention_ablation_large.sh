#!/bin/bash
# Launch script for Conditional Cross-Attention Diffusion Ablation Experiments (LARGE MODELS)
# This script submits all large model ablation experiment jobs to the HPC cluster
#
...
#
# Large models: 96 base_channels, depth 4, 8 attention heads
...
# =============================================================================
echo "=============================================================================="
echo "Launching Conditional Cross-Attention Diffusion Ablation Experiments (LARGE)"
echo "=============================================================================="
echo ""
...
echo ""
echo "Total experiments: ${#LARGE_EXPERIMENTS[@]}"
echo "=============================================================================="
echo ""

# Prompt for confirmation
read -p "Submit all large model ablation experiments? (y/N): " -n 1 -r
echo
if [[ ! $REPLY =~ ^[Yy]$ ]]; then
    echo "Aborted."
    exit 0
