#!/bin/bash
#BSUB -J stage2_unet128_d5_rb3
#BSUB -o /work3/s233249/ImgiNav/ImgiNav/training/hpc_scripts/logs/stage2_unet128_d5_rb3.%J.out
#BSUB -e /work3/s233249/ImgiNav/ImgiNav/training/hpc_scripts/logs/stage2_unet128_d5_rb3.%J.err
#BSUB -n 8
