#!/bin/bash
# Launch script for Medium Spatial CLIP Diffusion models on gpul40s queue
# Submits: medium_rooms_all, medium_scenes_all (2 experiments)
...
CONFIGS=(
    "experiments/diffusion/clip/spatial_rooms/medium_all.yaml"
    "experiments/diffusion/clip/spatial_scenes/medium_all.yaml"
)

echo "=============================================================================="
echo "Launching Medium Spatial CLIP Diffusion Training (gpul40s queue)"
echo "=============================================================================="
