#!/bin/bash
# Launch script for Large Spatial CLIP Diffusion models on gpul40s queue
...
CONFIGS=(
    "experiments/diffusion/clip/spatial_rooms/large_down_bottleneck.yaml"
    "experiments/diffusion/clip/spatial_scenes/large_down_bottleneck.yaml"
)

echo "=============================================================================="
echo "Launching Large Spatial CLIP Diffusion Training (gpul40s queue)"
echo "=============================================================================="
