#!/bin/bash
# Launch script for rooms-only spatial experiments with text/graph conditioning only (no POV)
...
CONFIGS=(
    "experiments/diffusion/clip/spatial_rooms/small_down_bottleneck_text_only.yaml"
    "experiments/diffusion/clip/spatial_rooms/medium_down_bottleneck_text_only.yaml"
    "experiments/diffusion/clip/spatial_rooms/large_down_bottleneck_text_only.yaml"
)

echo "=============================================================================="
echo "Launching Spatial Rooms-Only Experiments (Text/Graph Only, Down+Bottleneck Attention)"
echo "=============================================================================="
