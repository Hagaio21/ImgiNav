#!/bin/bash
# Launch script for Large Scenes CLIP Diffusion models on gpul40s queue
# Note: Configs may need to be created first

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
BASE_DIR="/work3/s233249/ImgiNav/ImgiNav"
TRAIN_SCRIPT="${SCRIPT_DIR}/run_train_diff_clip.sh"

# Add configs here when they are created
CONFIGS=(
    # "experiments/diffusion/clip/regular_scenes/large_bottleneck.yaml"
    # "experiments/diffusion/clip/regular_scenes/large_all.yaml"
    # "experiments/diffusion/clip/regular_scenes/large_down.yaml"
    # "experiments/diffusion/clip/regular_scenes/large_up.yaml"
)

if [ ${#CONFIGS[@]} -eq 0 ]; then
    echo "WARNING: No configs specified. Please add config paths to CONFIGS array."
    exit 1
fi

echo "=============================================================================="
echo "Launching Large Scenes CLIP Diffusion Training (gpul40s queue)"
echo "=============================================================================="
