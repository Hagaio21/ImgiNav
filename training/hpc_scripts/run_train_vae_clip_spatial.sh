...
VAE_CONFIG="${BASE_DIR}/experiments/autoencoders/new_layouts/new_layouts_VAE_32x32_structural_256_clip_spatial.yaml"
...
# =============================================================================
echo "=========================================="
echo "Training VAE with CLIP Loss (SPATIAL ALIGNMENT)"
echo "=========================================="
...
# Run training
echo ""
echo "Starting VAE training with CLIP loss (spatial alignment)..."
echo "=========================================="
