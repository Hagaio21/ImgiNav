#!/bin/bash
# Launcher script for Stage 1 & 2 array job
...
JOB_SCRIPT="${SCRIPT_DIR}/run_stage1_stage2_array.sh"
...
if [ $# -gt 0 ]; then
    ...
    echo "to process valid_scenes.txt through Stage 1 and Stage 2."
    echo ""
...
# =============================================================================
echo "=============================================================================="
echo "Launching Stage 1 & 2 Array Job"
echo "=============================================================================="
echo ""
